...
if __name__ == '__main__':
    ...
    weight_name = 'backbone.patch_embed.conv1.weight'

    checkpoint_path = './mask2former_internimage_h-mmseg2.pth'
    checkpoint_3channel = CheckpointLoader.load_checkpoint(checkpoint_path, map_location='cpu')
    save_path_10channel = './mask2former_internimage_h-mmseg2-4chan.pth'
    ...
    with torch.no_grad():
        ...
        new_weight = torch.zeros((160, 4, 3, 3))
